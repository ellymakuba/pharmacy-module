...
$j("input[name=patientId]").live("focus", function () {
    $j(this).autocomplete({
        ...
        select:function (event, ui) {
            ...
            $j.ajax({
                 type:"GET",
                 url:"patientLastEncounterDetails.form?patientUUID="+patient,
                 async:false,
                 dataType:"json",
                 success:function (result){
                 if(result ==""){
                 ...
                 pharmacyEncounterDetails= result.toString().split(",");
                 $j("#align_left").append("Last Visit Date: "+pharmacyEncounterDetails[0]+"</br>");
                 $j("#align_left").append("Medication: "+pharmacyEncounterDetails[2]+"</br>");
                 $j("#align_right").append("Site Of visit: "+pharmacyEncounterDetails[1]+"</br>");
                 $j("#align_right").append("Served By: "+pharmacyEncounterDetails[3]+"</br>");
                 }
                 }
             });
