...
<DIV id="dtab_1">
        ...
        <fieldset>
            ...
            <table id="tableDispense">
                ...
                <tr class="newRowClass" >
                    <td ><input type="text" name="drugdispense" id="drugdispense" style="width: 350px; "/></td>
     ...
     <form id="completeReceipt" name="completeReceipt">
         <fieldset>
             ...
             <table id="receiptToComplete">
                 <thead><tr><th>Drug</th><th>Quantity</th><th>Amount</th></tr></thead>
                 <tbody></tbody>
             </table>
             </fieldset>
         <fieldset>
             <table id="waiverAndTotals">
                 ...
                 <tr>
                     <td></td><input type="text" name="receiptTotal" id="receiptTotal"></td>
                     <td></td><input type="text" name="amountPaid" id="amountPaid"></td>
                     <td></td><input type="text" name="amountWaived" id="amountWaived"></td>
                     <td></td><input type="text" name="balance" id="balance"></td>
                 </tr>
             </table>
    ...
    <table id="unClearedReceipts" cellpadding="0" cellspacing="0" border="0" class="display">
      <thead>
      <th>EncounterUUID</th>
      <th>Patient ID</th>
      <th>Patient Name</th>
