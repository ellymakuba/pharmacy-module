    ...
    <form id="s11">
        <fieldset>
            ...
            <table id="tableincoming">
                <tr><th>Drug</th><th>Category</th><th>Quantity</th><th class="hidable">Expiry date</th><th class="hidable">Batch NO</th><th class="hidable">Buying Price</th><th class="hidable">Selling Price</th></tr>
                <tr><td><input type="text" name="incomingdrug" id="incomingdrug" class="required"/> </td>
                    ...
                    <td><input type="text"  name="date" id="date" style="width:100px;" class="hidable"/></td>
                    <td><input type="text" name="batchNo" id="batchNo" style="width:100px;" class="hidable"/> </td>
                    <td><input type="text" name="buyingPrice" id="buyingPrice" style="width:100px;" class="hidable" value="0"/> </td>
                    <td><input type="text" name="unitPrice" id="unitPrice" style="width:100px;" class="hidable" value="0"/> </td>
                </tr>
            </table>
