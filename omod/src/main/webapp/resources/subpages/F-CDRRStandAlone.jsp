...
<head>
   ...
   #StandAloneFCDRReportDIV{
             margin:5px;
             border:5px #AAAAAA;
           }
            #StandAloneFCDRReportDIV table{
...
<div id="StandAloneFCDRReportDIV">
   ...
   <input type="button" onclick="tableToExcel('StandAloneFCDRReportTable', 'Export Data')" value="Export to Excel"/></br></br></br>
...
%>
<h1><a>FCDR Report For Stand Alone Site Between <%=reportStartDate %> To <%=reportEndDate%></a></h1>
	<table id="StandAloneFCDRReportTable" class="visibleBorder">
		<thead>
			<tr>
		...
		<tbody>
           ...
           Drug drugFromContext = Context.getConceptService().getDrugByNameOrId(pharmacyStoreInstance.getDrugs().getId().toString());
                       ...
                       for(DrugTransactions drugTransactionInstance:transferedDrugTransactions){
                        ...
                        quantityRequiredForResupply=((quantityOfDrugDispensed*3)-(pharmacyStoreInstance.getQuantity()/unitsInAPack));
                        %>
                       <tr>
                        ...
                        <td><%=quantityOfDrugDispensed/unitsInAPack%></td>
                        <td></td>
                        <td><%=drugReceivedQuantityTotal/unitsInAPack%></td>
                        <td><%=drugTransferedQuantityTotal/unitsInAPack%></td>
