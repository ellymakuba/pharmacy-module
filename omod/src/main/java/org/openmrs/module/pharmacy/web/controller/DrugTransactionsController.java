...
public class DrugTransactionsController {
    ...
    @RequestMapping(method=RequestMethod.GET,value="module/pharmacy/resources/subpages/drugInventoryMovement")
    public void displayDrugInventoryMovement(ModelMap map,HttpServletRequest request) throws java.text.ParseException, IOException {
